...
import { NewsArticle } from "@/lib/news/news-helpers";
...
function Home() {
  ...
  return (
    <div className={"flex flex-col min-h-screen bg-[#f4f7f4] dark:bg-bg text-fg " + (isRTL ? "font-serif" : "font-sans")}>
      {/* 🌦️ 1. MULTILINGUAL TOP SMART BAR (WEATHER + TRIPLE DATE + AQI + NAMAZ + STOCK TICKER) */}
      <DailyWeatherBar />

      {/* 🏛️ 2. MAIN DASHBOARD CONTENT */}
      <main className="mx-auto max-w-7xl w-full px-4 py-6 sm:py-8 space-y-8 flex-1">
        ...
        <div className="grid gap-6 lg:grid-cols-12 items-stretch">
          ...
          <div className="lg:col-span-7 rounded-3xl border border-border/90 bg-surface p-6 shadow-sm flex flex-col justify-between">
            <div className="space-y-4">
              <div className="flex items-center justify-between border-b border-border/80 pb-3">
                <h2 className="font-display text-xl font-black text-primary flex items-center gap-2">
                  <Flame className="size-5 text-red-600 animate-pulse" /> {t("topBreakingNews")}
                </h2>
                <Link
                  to="/news"
                  className="text-xs font-bold text-primary hover:underline flex items-center gap-1"
                >
                  {t("allNews")} <ChevronRight className="size-3.5" />
                </Link>
              </div>
            ...
            <div className="pt-4 mt-2 border-t border-border/60 flex items-center justify-between text-xs text-muted">
              <div className="flex items-center gap-1.5">
                ...
                <span className="font-medium text-[11px]">{t("verifiedPress")}</span>
              </div>
          ...
          {/* RIGHT 5 COLUMNS: 1-TAP QUICK TOOLS + HISTORY CARD */}
            ...
            <div className="rounded-3xl border border-border/90 bg-surface p-6 shadow-sm space-y-4">
              <div className="flex items-center justify-between border-b border-border/80 pb-3">
                <h2 className="font-display text-lg font-black text-primary flex items-center gap-2">
                  <Zap className="size-4.5 text-accent" /> {t("quickTools")}
                </h2>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-[10px] text-muted truncate">{t("affidavitDesc")}</div>
                  </div>
                </Link>
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-[10px] text-muted truncate">{t("pakIdDesc")}</div>
                  </div>
                </Link>
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-[10px] text-muted truncate">{t("dlimsDesc")}</div>
                  </div>
                </Link>
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-[10px] text-muted truncate">{t("landFardDesc")}</div>
                  </div>
                </Link>
              </div>
            </div>
        ...
        {/* 📚 3. COMPLETE CIVIC DATABASE CATEGORIES */}
        <section className="pt-4 border-t border-border/70 space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="font-display text-xl font-black text-primary flex items-center gap-2">
              <ShieldCheck className="size-5 text-accent" /> {t("completeDatabase")}
            </h2>
            ...
            {categories.map((cat) => (
              ...
              >
                ...
                <div className="text-[11px] font-bold text-primary inline-flex items-center gap-1 group-hover:translate-x-1 transition-transform pt-2 border-t border-border/50">
                  <span>{t("viewGuides")}</span> <ChevronRight className="size-3" />
                </div>
              </Link>
            ))}
          </div>
